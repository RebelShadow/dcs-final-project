...
public class Controller6F_I2 {
    ...
    public static void main(String[] args) {
        ...
        OP7.SetName("OP7");
        OP7.Value = new TransferOperation("localhost", "1082", "TL5");
        pn.PlaceList.add(OP7);

        DataTransfer OP8 = new DataTransfer();
        OP8.SetName("OP8");
        OP8.Value = new TransferOperation("localhost", "1082", "TL6");
        pn.PlaceList.add(OP8);

        DataTransfer OP9 = new DataTransfer();
        OP9.SetName("OP9");
        OP9.Value = new TransferOperation("localhost", "1082", "TL7");
        pn.PlaceList.add(OP9);

        DataTransfer OP10 = new DataTransfer();
        OP10.SetName("OP10");
        OP10.Value = new TransferOperation("localhost", "1082", "TL8");
        pn.PlaceList.add(OP10);

        DataTransfer OP11 = new DataTransfer();
        OP11.SetName("OP11");
        OP11.Value = new TransferOperation("localhost", "1082", "TL5_L");
        pn.PlaceList.add(OP11);

        DataTransfer OP12 = new DataTransfer();
        OP12.SetName("OP12");
        OP12.Value = new TransferOperation("localhost", "1082", "TL7_L");
        ...
        grdiniT.Activations.add(new Activation(iniT, "ini", TransitionOperation.SendOverNetwork, "OP10"));
        grdiniT.Activations.add(new Activation(iniT, "ini", TransitionOperation.SendOverNetwork, "OP11"));
        grdiniT.Activations.add(new Activation(iniT, "ini", TransitionOperation.SendOverNetwork, "OP12"));
        ...
        grdT1.Activations.add(new Activation(t1, "green", TransitionOperation.SendOverNetwork, "OP7"));
        ...
        grdT2.Activations.add(new Activation(t2, "yellow", TransitionOperation.SendOverNetwork, "OP7"));
        ...
        grdT3.Activations.add(new Activation(t3, "green", TransitionOperation.SendOverNetwork, "OP8"));
        grdT3.Activations.add(new Activation(t3, "red", TransitionOperation.SendOverNetwork, "OP7"));
        ...
        grdT4.Activations.add(new Activation(t4, "yellow", TransitionOperation.SendOverNetwork, "OP8"));
        ...
        grdT5.Activations.add(new Activation(t5, "green", TransitionOperation.SendOverNetwork, "OP9"));
        grdT5.Activations.add(new Activation(t5, "red", TransitionOperation.SendOverNetwork, "OP8"));
        ...
        grdT6.Activations.add(new Activation(t6, "yellow", TransitionOperation.SendOverNetwork, "OP9"));
        ...
        grdT7.Activations.add(new Activation(t7, "green", TransitionOperation.SendOverNetwork, "OP10"));
        grdT7.Activations.add(new Activation(t7, "red", TransitionOperation.SendOverNetwork, "OP9"));
        ...
        grdT8.Activations.add(new Activation(t8, "yellow", TransitionOperation.SendOverNetwork, "OP10"));
        ...
        grdT9.Activations.add(new Activation(t9, "green", TransitionOperation.SendOverNetwork, "OP11"));
        grdT9.Activations.add(new Activation(t9, "red", TransitionOperation.SendOverNetwork, "OP10"));
        ...
        grdT10.Activations.add(new Activation(t10, "yellow", TransitionOperation.SendOverNetwork, "OP11"));
        ...
        grdT11.Activations.add(new Activation(t11, "green", TransitionOperation.SendOverNetwork, "OP12"));
        grdT11.Activations.add(new Activation(t11, "red", TransitionOperation.SendOverNetwork, "OP11"));
        ...
        grdT12.Activations.add(new Activation(t12, "yellow", TransitionOperation.SendOverNetwork, "OP12"));
        ...
        grdT13.Activations.add(new Activation(t13, "red", TransitionOperation.SendOverNetwork, "OP12"));
        ...
        t_f1.InputPlaceName.add("IN7");
        t_f1.IsAsync = true;

        Condition T_f1Ct1 = new Condition(t_f1, "P_f1", TransitionCondition.NotNull);
        Condition T_f1Ct2 = new Condition(t_f1, "IN7", TransitionCondition.IsNull);
        ...
        Condition T_f1Ct3 = new Condition(t_f1, "IN7", TransitionCondition.NotNull);
        ...
        t_f2.InputPlaceName.add("IN8");
        t_f2.IsAsync = true;

        Condition T_f2Ct1 = new Condition(t_f2, "P_f2", TransitionCondition.NotNull);
        Condition T_f2Ct2 = new Condition(t_f2, "IN8", TransitionCondition.IsNull);
        ...
        Condition T_f2Ct3 = new Condition(t_f2, "IN8", TransitionCondition.NotNull);
        ...
        t_f3.InputPlaceName.add("IN9");
        t_f3.IsAsync = true;

        Condition T_f3Ct1 = new Condition(t_f3, "P_f3", TransitionCondition.NotNull);
        Condition T_f3Ct2 = new Condition(t_f3, "IN9", TransitionCondition.IsNull);
        ...
        Condition T_f3Ct3 = new Condition(t_f3, "IN9", TransitionCondition.NotNull);
        ...
        t_f4.InputPlaceName.add("IN10");
        t_f4.IsAsync = true;

        Condition T_f4Ct1 = new Condition(t_f4, "P_f4", TransitionCondition.NotNull);
        Condition T_f4Ct2 = new Condition(t_f4, "IN10", TransitionCondition.IsNull);
        ...
        Condition T_f4Ct3 = new Condition(t_f4, "IN10", TransitionCondition.NotNull);
        ...
        t_f5.InputPlaceName.add("IN11");
        t_f5.IsAsync = true;

        Condition T_f5Ct1 = new Condition(t_f5, "P_f5", TransitionCondition.NotNull);
        Condition T_f5Ct2 = new Condition(t_f5, "IN11", TransitionCondition.IsNull);
        ...
        Condition T_f5Ct3 = new Condition(t_f5, "IN11", TransitionCondition.NotNull);
        ...
        t_f6.InputPlaceName.add("IN12");
        t_f6.IsAsync = true;

        Condition T_f6Ct1 = new Condition(t_f6, "P_f6", TransitionCondition.NotNull);
        Condition T_f6Ct2 = new Condition(t_f6, "IN12", TransitionCondition.IsNull);
        ...
        Condition T_f6Ct3 = new Condition(t_f6, "IN12", TransitionCondition.NotNull);
