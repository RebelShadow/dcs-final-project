...
public class Lanes_Intersection_Modified {
	public static void main(String[] args) {
		...
		tOut1.InputPlaceName.add("P_a1");
		tOut1.InputPlaceName.add("P_x1");
		tOut1.IsAsync = true;

		Condition tOut1Ct1 = new Condition(tOut1, "P_a1", TransitionCondition.NotNull);
		Condition tOut1Ct2 = new Condition(tOut1, "P_x1", TransitionCondition.CanNotAddCars);
		tOut1Ct1.SetNextCondition(LogicConnector.AND, tOut1Ct2);

		GuardMapping grdtOut1 = new GuardMapping();
		grdtOut1.condition= tOut1Ct1;
		grdtOut1.Activations.add(new Activation(tOut1, "full", TransitionOperation.SendOverNetwork, "op1"));
		tOut1.GuardMappingList.add(grdtOut1);
		...
		tOut2.InputPlaceName.add("P_a2");
		tOut2.InputPlaceName.add("P_x2");
		tOut2.IsAsync = true;

		Condition tOut2Ct1 = new Condition(tOut2, "P_a2", TransitionCondition.NotNull);
		Condition tOut2Ct2 = new Condition(tOut2, "P_x2", TransitionCondition.CanNotAddCars);
		tOut2Ct1.SetNextCondition(LogicConnector.AND, tOut2Ct2);

		GuardMapping grdtOut2 = new GuardMapping();
		grdtOut2.condition= tOut2Ct1;
		grdtOut2.Activations.add(new Activation(tOut2, "full", TransitionOperation.SendOverNetwork, "op2"));
		tOut2.GuardMappingList.add(grdtOut2);
		...
		tOut3.InputPlaceName.add("P_a3");
		tOut3.InputPlaceName.add("P_x3");
		tOut3.IsAsync = true;

		Condition tOut3Ct1 = new Condition(tOut3, "P_a3", TransitionCondition.NotNull);
		Condition tOut3Ct2 = new Condition(tOut3, "P_x3", TransitionCondition.CanNotAddCars);
		tOut3Ct1.SetNextCondition(LogicConnector.AND, tOut3Ct2);

		GuardMapping grdtOut3 = new GuardMapping();
		grdtOut3.condition= tOut3Ct1;
		grdtOut3.Activations.add(new Activation(tOut3, "full", TransitionOperation.SendOverNetwork, "op3"));
		tOut3.GuardMappingList.add(grdtOut3);
		...
		tOut4.InputPlaceName.add("P_a4");
		tOut4.InputPlaceName.add("P_x4");
		tOut4.IsAsync = true;

		Condition tOut4Ct1 = new Condition(tOut4, "P_a4", TransitionCondition.NotNull);
		Condition tOut4Ct2 = new Condition(tOut4, "P_x4", TransitionCondition.CanNotAddCars);
		tOut4Ct1.SetNextCondition(LogicConnector.AND, tOut4Ct2);

		GuardMapping grdtOut4 = new GuardMapping();
		grdtOut4.condition= tOut4Ct1;
		grdtOut4.Activations.add(new Activation(tOut4, "full", TransitionOperation.SendOverNetwork, "op4"));
		tOut4.GuardMappingList.add(grdtOut4);
